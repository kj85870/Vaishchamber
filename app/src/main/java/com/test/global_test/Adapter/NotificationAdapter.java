...
import com.test.global_test.Activity.NotificationActivity;
...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.NewsViewHolder> implements Filterable {
    ...
    public NotificationAdapter(Context mContext, List<NewsItem> mData, boolean isDark) {
    ...
    public NotificationAdapter(Context mContext, List<NewsItem> mData) {
        this.mContext = mContext;
        this.mData = mData;
        this.mDataFiltered = mData;
    ...
    public NewsViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup,int i) {
        ...
        View layout;
        layout = LayoutInflater.from(mContext).inflate(R.layout.layout_notification,viewGroup,false);
